...
begin
  ...
  Application.Run;
      ...
      if ParamStr(1) = APP_CMD_PARAM_CLOSE then PostMessage(PMemFile^.MainHandle, AR_MESSAGE_CLOSE, 0, 0) else PostMessage(PMemFile^.MainHandle, AR_MESSAGE_RESTORE, 0, 0);
    end;
  finally
    CloseSharedFile;
  end;
